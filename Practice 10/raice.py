...
image_player = load_img('greencar.png', (55, 110)) # Чуть меньше для маневренности
image_enemy = load_img('redcar.png', (55, 110))
...
while running:
    ...
    # Коллизия с врагом (ИСПОЛЬЗУЕМ INFLATE)
    # Мы уменьшаем хитбокс на 15 пикселей по ширине и 30 по высоте
    # Это делает игру приятнее: визуально ты можешь чуть-чуть задеть врага, но не проиграть
